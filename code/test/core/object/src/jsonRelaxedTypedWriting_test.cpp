...
static const PrintFlags PRINT_FLAGS = { PrintFlagBit::NoHeader, PrintFlagBit::Relaxed };

TEST(JSONRelaxedWrite, SimpleInt)
{
    const int value = 42;
...
TEST(JSONRelaxedWrite, SimpleFloat)
{
...
TEST(JSONRelaxedWrite, SimpleBool)
{
...
TEST(JSONRelaxedWrite, SimpleString)
{
...
TEST(JSONRelaxedWrite, SimpleStringWithEscapement)
{
	const StringBuf value = "Ala <ma> \"kota\"";
	const auto data = TypedMemory::Wrap(value);
...
TEST(JSONRelaxedWrite, SimpleStringMultiline)
{
...
TEST(JSONRelaxedWrite, Compound)
{
...
TEST(JSONRelaxedWrite, BigCompound)
{
...
TEST(JSONRelaxedWrite, ArrayCompound)
{
...
TEST(JSONRelaxedWrite, Enumeration)
{
...
TEST(JSONRelaxedWrite, EnumerationMissing)
{
...
TEST(JSONRelaxedWrite, BitfieldEmpty)
{
	const TestFlags val;
	const auto data = TypedMemory::Wrap(val);
...
TEST(JSONRelaxedWrite, BitfieldSingle)
{
...
TEST(JSONRelaxedWrite, BitfieldTwoFlags)
{
...
TEST(JSONRelaxedWrite, BitfieldMissingFlag)
{
...
TEST(JSONRelaxedWrite, BitfieldFlagMixed)
{
...
TEST(JSONRelaxedWrite, CustomType)
{
...
TEST(JSONRelaxedWrite, NullPointer)
{
	const ObjectPtr ptr;
...
TEST(JSONRelaxedWrite, EmptyObject)
{
...
TEST(JSONRelaxedWrite, ObjectWithSimpleProp)
{
...
TEST(JSONRelaxedWrite, NestedObject)
{
	const RefPtr<TestObject> ptr = RefNew<TestObject>();
...
TEST(JSONRelaxedWrite, IndexedObject)
{
	const RefPtr<TestObject> ptr = RefNew<TestObject>();
...
TEST(JSONRelaxedWrite, KnownWeakPtrSurvives)
{
	const RefPtr<TestObject> ptr = RefNew<TestObject>();
	ptr->ptr = RefNew<TestObject>();
	ptr->weakPtr = ptr->ptr;
...
TEST(JSONRelaxedWrite, UnknownWeakPtrGetsNulled)
{
	const RefPtr<TestObject> ptr = RefNew<TestObject>();
	ptr->ptr = RefNew<TestObject>();
...
TEST(JSONRelaxedWrite, ResourceEmpty)
{
...
TEST(JSONRelaxedWrite, ResourceExternal)
{
...
TEST(JSONRelaxedWrite, ResourceInternal)
{
...
TEST(JSONRelaxedWrite, ResourceInternalDupllicated)
{
	auto resPtr = RefNew<TestResource>();
...
TEST(JSONRelaxedWrite, BufferEmpty)
{
	Buffer dataBuf;
...
TEST(JSONRelaxedWrite, BufferSimple)
{
...
TEST(JSONRelaxedWrite, AsyncBufferEmpty)
{
...
TEST(JSONRelaxedWrite, AsyncBufferSimple)
{
	uint8_t bytes[3] = { 'a','b','c' };
...
TEST(JSONRelaxedWrite, Save1000)
{
	bm::Random r;
	TestLayerGenerationSettings settings;
