...
#include "bm/core/object/include/rttiClassRefType.h"
...
{
    RTTI_DECLARE_OBJECT_CLASS(BaseClassA, IObject);
...
{
    RTTI_DECLARE_OBJECT_CLASS(DevClassB, BaseClassA);
...
{
    RTTI_DECLARE_OBJECT_CLASS(DevClassC, BaseClassA);
