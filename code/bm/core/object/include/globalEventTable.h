...
class BM_CORE_OBJECT_API IGlobalEventTable : public MainPoolData<NoCopy>
{
public:
    IGlobalEventTable();
...
protected:
    struct Table : public MainPoolData<NoCopy>
    {
...
class BM_CORE_OBJECT_API GlobalEventTable : public IGlobalEventTable
{
public:
