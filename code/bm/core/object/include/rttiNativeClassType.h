...
class BM_CORE_OBJECT_API NativeClass : public IClassType
{
public:
    NativeClass(const char* name, uint32_t size, uint32_t alignment, uint64_t nativeHash);
    ...
    virtual bool isConstructible() const override;
