...
class BM_CORE_OBJECT_API IGlobalEventListener : public IReferencable
{
public:
...
extern BM_CORE_OBJECT_API void RegisterGlobalEventListener(IGlobalEventListener* listener);

/// unregister a global event listener
extern BM_CORE_OBJECT_API void UnregisterGlobalEventListener(IGlobalEventListener* listener);

/// dispatch global event
extern BM_CORE_OBJECT_API void DispatchGlobalEvent(GlobalEventKey key, StringID eventName, IObject* source = nullptr, const void* data = nullptr, Type dataType = Type());
