...
class BM_CORE_OBJECT_API IDataViewObserver : public MainPoolData<NoCopy>
{
public:
...
struct BM_CORE_OBJECT_API DataViewActionResult
{
    ActionPtr action;
...
class BM_CORE_OBJECT_API IDataView : public IReferencable
{
public:
    IDataView();
    virtual ~IDataView();
...
protected:
    ...
    struct Path : public MainPoolData<NoCopy>
    {
        Path* parent = nullptr;
