...
SERIALIZATION_OPCODE(DataBlock1) // raw binary data
SERIALIZATION_OPCODE(DataBlock2) // raw binary data
SERIALIZATION_OPCODE(DataBlock4) // raw binary data
SERIALIZATION_OPCODE(DataAdaptiveNumber) // raw binary data
...
SERIALIZATION_OPCODE(NextPage) // used only during data building, points to next page of memory
