...
struct BM_CORE_OBJECT_API IStub : public MainPoolData<NoCopy>
{	
public:
	IStub();
	virtual ~IStub();
...
template< typename T >
struct StubPseudoArray : public MainPoolData<NoCopy>
{
...
class BM_CORE_OBJECT_API IStubWriter : public MainPoolData<NoCopy>
{
public:
	virtual ~IStubWriter();
...
class BM_CORE_OBJECT_API IStubReader : public MainPoolData<NoCopy>
{
public:
