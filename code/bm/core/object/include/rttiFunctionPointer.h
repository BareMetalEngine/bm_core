...
typedef void (*TFunctionWrapperPtr)(void* contextPtr, const void* params, void* result);

// script calling wrapper pointer
typedef void* TFunctionScriptWrapperPtr;

//---

// JITed function wrapper pointer
typedef void (*TFunctionJittedWrapperPtr)(void* context, const IFunctionStackFrame* stackFrame, const void* params, void* result);
