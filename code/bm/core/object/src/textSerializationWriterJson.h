...
class BM_CORE_OBJECT_API TextSerializationWriterJSON : public ITextSerializationWriter
{
public:
	TextSerializationWriterJSON(const TextSerializationMappedObjects& objects, const ObjectSavingContext& ctx, JSONWriter* doc);
	~TextSerializationWriterJSON();
...
private:
	...
	bool m_nextStructIsObject = false;;
};
