...
#include "bm/core/containers/include/baseArray.h"
...
class BM_CORE_OBJECT_API IArrayHelper : public MainPoolData<NoCopy>
{
public:
...
class BM_CORE_OBJECT_API ArrayGeneric : public IArrayHelper
{
public:
...
/// array for POD types
template< uint32_t N >
class BM_CORE_OBJECT_API ArrayPOD : public IArrayHelper
{
public:
    uint8_t m_alignment;
