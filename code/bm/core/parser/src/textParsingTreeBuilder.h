...
namespace prv
{
    ...
    class ParsingTreeBuilder : public MainPoolData<NoCopy>
    {
    public:
        ParsingTreeBuilder();
        ~ParsingTreeBuilder();
        ...
        // insert a match for hexadecimals
        void insertHexadecimalsMatch();
    ...
    private:
        ...
        void insertFloatingPointEnding(ParsingNode* node);
        void insertFloatingExponentEnding(ParsingNode* node);
        void insertFloatingExponentValueEnding(ParsingNode* node);
        void insertFloatingFractionPart(ParsingNode* node, bool hasNumberBefore);
        void insertFloatingPointMatchFull(ParsingNode* node);
    };
