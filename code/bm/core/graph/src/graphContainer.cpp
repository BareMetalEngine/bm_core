...
SupprotedBlockConnectionInfo::SupprotedBlockConnectionInfo(SpecificClassType<Block> cls)
    : blockClass(cls)
{}
...
void Container::removeBlock(const BlockPtr& block, bool modify)
{
...
void Container::addBlock(const BlockPtr& block, bool modify)
{
    ASSERT_EX(block, "Block to remove must be specified");
