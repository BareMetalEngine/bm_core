...
/// socket description
struct BM_CORE_GRAPH_API BlockSocketStyleInfo
{
    ...
    INLINE BlockSocketStyleInfo& multiconnection(bool multiconnection = true) { m_multiconnection = multiconnection; return *this; }
...
struct BM_CORE_GRAPH_API BlockLayoutBuilder
{
...
class BM_CORE_GRAPH_API Block : public IObject
{
    RTTI_DECLARE_OBJECT_CLASS(Block, IObject);
...
class BM_CORE_GRAPH_API BlockShapeMetadata : public IMetadata
{
...
class BM_CORE_GRAPH_API BlockInfoMetadata : public IMetadata
{
...
class BM_CORE_GRAPH_API BlockTitleColorMetadata : public IMetadata
{
...
// meta data with the block title color
class BM_CORE_GRAPH_API BlockStyleNameMetadata : public IMetadata
{
...
class BM_CORE_GRAPH_API BlockBorderColorMetadata : public IMetadata
{
...
class BM_CORE_GRAPH_API BlockHelpMetadata : public IMetadata
{
