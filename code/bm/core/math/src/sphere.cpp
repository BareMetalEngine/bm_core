...
RTTI_BEGIN_TYPE_CLASS(Sphere);
    ...
    RTTI_SCRIPT_CLASS_FUNCTION_EX("Radius", radius);
    RTTI_SCRIPT_CLASS_FUNCTION_EX("Position", _getPosition);
    RTTI_SCRIPT_CLASS_FUNCTION_EX("Volume", volume);
    RTTI_SCRIPT_CLASS_FUNCTION_EX("Bounds", bounds);
    RTTI_SCRIPT_CLASS_FUNCTION_EX("Contains", contains);
