...
Box OBB::bounds() const
{
    ...
    box.updateWithPoint(a);
    box.updateWithPoint(b);
    box.updateWithPoint(a + b);
    box.updateWithPoint(c);
    box.updateWithPoint(a + c);
    box.updateWithPoint(b + c);
    box.updateWithPoint(a + b + c);
