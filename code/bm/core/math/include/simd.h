...
extern BM_CORE_MATH_API const SIMDQuad FullOnesBitMask[1];
extern BM_CORE_MATH_API const SIMDQuad BitMasks[16];
extern BM_CORE_MATH_API const SIMDQuad MaskQuads[16];

extern BM_CORE_MATH_API const SIMDQuad ZeroVector[1];
extern BM_CORE_MATH_API const SIMDQuad OnesVector[1];
extern BM_CORE_MATH_API const SIMDQuad EXVector[1];
extern BM_CORE_MATH_API const SIMDQuad EYVector[1];
extern BM_CORE_MATH_API const SIMDQuad EZVector[1];
extern BM_CORE_MATH_API const SIMDQuad EWVector[1];

extern BM_CORE_MATH_API const SIMDQuad ZeroValue[1];
extern BM_CORE_MATH_API const SIMDQuad OneValue[1];
extern BM_CORE_MATH_API const SIMDQuad EpsilonValue[1];
extern BM_CORE_MATH_API const SIMDQuad EpsilonSquaredValue[1];

extern BM_CORE_MATH_API const SIMDQuad SignBitVecto[1];
extern BM_CORE_MATH_API const SIMDQuad SignBitVector3[1];
extern BM_CORE_MATH_API const SIMDQuad SignMaskVector[1];
extern BM_CORE_MATH_API const SIMDQuad SignMaskVector3[1];


//---

/// 128-bit simd quad
TYPE_ALIGN(16, class) BM_CORE_MATH_API SIMDQuad
{
public:
    INLINE SIMDQuad();
