...
INLINE Color Color::min(Color other) const
{
    return Color(std::min(r, other.r), std::min(g, other.g), std::min(b, other.b), std::min(a, other.a));
}

INLINE Color Color::max(Color other) const
{
    return Color(std::max(r, other.r), std::max(g, other.g), std::max(b, other.b), std::max(a, other.a));
}
