...
struct BM_CORE_CONTAINERS_API StaticStructurePoolBase : public MainPoolData<NoCopy>
{
public:
    StaticStructurePoolBase(uint32_t elemSize, uint32_t elemAlign, const char* tag = nullptr);
...
{
public:
    INLINE StaticStructurePool(const char* tag = nullptr);
