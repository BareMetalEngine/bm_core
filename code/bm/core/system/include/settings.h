...
// System headers
    ...
    #define PLATFORM_PSX
    #define PLATFORM_PROSPERO
    #define PLATFORM_LITTLEENDIAN
    #define PLATFORM_CLANG
    #define PLATFORM_NAME "prospero"
    #define PLATFORM_X64
    #define PLATFORM_64BIT
    ...
    #define SCE_KERNEL_VALIDATE(expr) { auto ret = (expr); ASSERT_EX(ret == SCE_OK, "Important kernel call failed"); }
...
#elif defined(__i386__) || defined(__amd64__) || defined(_M_AMD64) || defined(_M_IX86)
...
#define BEGIN_INFERNO_NAMESPACE() namespace bm {
#define END_INFERNO_NAMESPACE() }

#define BEGIN_INFERNO_NAMESPACE_EX(name) namespace bm { namespace name {
#define END_INFERNO_NAMESPACE_EX(name) } }
