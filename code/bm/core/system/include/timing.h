...
class BM_CORE_SYSTEM_API NativeTimePoint
{
public:
    ...
    // get time elapsed from given time point till now and reset the timer to now
    NativeTimeInterval timeTillNowAndReset();
...
class BM_CORE_SYSTEM_API NativeTimeInterval
{
public:
