...
public:
    ...
    void print(LogOutputLevel level, const char* file, uint32_t line, const char* text);
...
public:
    ...
    void takeOwnership(LogOutputLevel level, const char* contextFile, uint32_t contextLine);
...
private:
    ...
    LogOutputLevel m_currentLevel = LogOutputLevel::Info;
